...
namespace Kesco.Lib.Entities.Documents
{
    ...
    public class DocLink : Entity, ICloneable<DocLink>
    {
        ...
        public static List<int> LoadChildDocsById(int id)
        {
                ...
                ConnString))
            {
                if (dbReader.HasRows)
                {
                    ...
                    while (dbReader.Read()) res.Add(dbReader.GetInt32(colКодЛица));
                }
            }
        ...
        public static List<DocLink> LoadBaseDocs(int docId, int fieldId)
        {
            ...
            using (var dbReader = new DBReader(SQLQueries.SELECT_СвязиДокументов_ПоВытекающему_ПоПолю, CommandType.Text,
                ConnString, param))
            {
                if (dbReader.HasRows)
                {
        ...
        public static List<int> LoadBasisDocsIdByChildId(int id)
        {
            ...
            using (var dbReader = new DBReader(SQLQueries.SELECT_СвязиДокументов_ПоВытекающему, id, CommandType.Text,
                ConnString))
            {
                if (dbReader.HasRows)
                {
        ...
        public static int GetLinkId(int parentDocId, int childDocId)
        {
            ...
            var res = DBManager.ExecuteScalar(SQLQueries.SELECT_СвязиДокументов_ПоОснованию_ПоВытекающему,
                CommandType.Text, ConnString, param);
        ...
        public static int GetLinkId(int parentDocId, int childDocId, int? docFieldId)
        {
            ...
            var res = DBManager.ExecuteScalar(SQLQueries.SELECT_СвязиДокументов_ПоОснованию_ПоВытекающему_ПоПолю,
                CommandType.Text, ConnString, param);
        ...
        public static void Delete(int parentDocId, int childDocId, int? docFieldId, List<DBCommand> cmds = null)
        {
            ...
            DBManager.ExecuteNonQuery(SQLQueries.DELETE_СвязиДокументов_ПоОснованию_ПоВытекающему_ПоПолю,
                CommandType.Text, ConnString, param);
        }
