...
namespace Kesco.Lib.Entities.Documents.EF.Trade
{
    ...
    public class SchetFactura : Document
    {
        ...
        ///  Документ основание
        /// </summary>
        public Document Osnovanie {get{return new Document(_Osnovanie);}}

        /// <summary>
        /// Документ корректирующий
        /// </summary>
        public string _CorrectingFlag
        {
            get { return CorrectingFlagField.ValueString; }
           // set { CorrectingFlagField.Value =  value; }
        }
        ...
        public override Currency Currency
        {
            get
            {
                return Currency.GetCurrency(CurrencyField.ValueInt);
            }
        }
        ...
        public Prilozhenie Prilozhenie
        {
            get
            {
                if (_prilozhenie == null)
                {
                    ...
                    {
                        _prilozhenie = new Prilozhenie(id);
                    }
                }
        ...
        public string _Platezhki
        {
            get
            {
                return GetBaseDoc(PlatezhkiField.DocFieldId);
            }
            set
            {
                SetBaseDoc(PlatezhkiField.DocFieldId, value.ToInt());
            }
        }
        ...
        public string _Schets
        {
            get
            {
                return GetBaseDoc(SchetField.DocFieldId);
            }
            set
            {
                SetBaseDoc(SchetField.DocFieldId, value.ToInt());
            }
        }
        ...
        {
            get { return _BillOfLading.IsNullEmptyOrZero() ? new Document() : new Document(_BillOfLading); }   
        }

        /// <summary>
        ///  Грузополучатель объект Person
        /// </summary>
        public PersonOld GPPerson
        {
            get
            {
                return new PersonOld(GPPersonField.ValueString);
            }
        }
        ...
        /// </summary>
        public PersonOld GOPerson
        {
            get
            {
                return new PersonOld(GOPersonField.ValueString);
            }
        }
        ...
        /// ID корректируемого документа
        /// </summary>
        public int CorrectingDocId
        {
            get
            {
                return GetBaseDoc(CorrectingDocField.DocFieldId).ToInt();
            }
        }
