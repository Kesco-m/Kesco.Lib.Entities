...
namespace Kesco.Lib.Entities.Documents.EF.Dogovora
{
    ...
    /// </summary>
    [Serializable]
    [DBSource("vwПозицииДоговоров", SQLQueries.SELECT_ID_ПозицияДоговора,
        SQLQueries.SELECT_ID_ПозицииДоговораПоРесурсу)]
    public class DogovorPosition : DocumentPosition<DogovorPosition>
    {
        ...
        ///     Документ
        /// </summary>
        public Document Document => new Document(DocumentId.ToString());
        ...
        ///     Ресурс
        /// </summary>
        public Resource Resource => new Resource(ResourceId.ToString());
