...
namespace Kesco.Lib.Entities.Documents
{
    ...
    public class DocumentData : Entity, ICloneable<DocumentData>
    {
        ...
        /// </summary>
        public int DocCode { get { return Id.ToInt(); } }
        ...
        public void FillData(int id)
        {
            using (var dbReader = new DBReader(SQLQueries.SELECT_ID_ДокументДанные, id, CommandType.Text, CN))
            {
                if (dbReader.HasRows)
                {
                    ...
                    int colКодЛица1 = dbReader.GetOrdinal("КодЛица1");
                    int colКодЛица2 = dbReader.GetOrdinal("КодЛица2");
                    int colКодЛица3 = dbReader.GetOrdinal("КодЛица3");
                    int colКодЛица4 = dbReader.GetOrdinal("КодЛица4");
                    int colКодЛица5 = dbReader.GetOrdinal("КодЛица5");
                    int colКодЛица6 = dbReader.GetOrdinal("КодЛица6");
                    int colКодСклада1 = dbReader.GetOrdinal("КодСклада1");
                    int colКодСклада2 = dbReader.GetOrdinal("КодСклада2");
                    int colКодСклада3 = dbReader.GetOrdinal("КодСклада3");
                    int colКодСклада4 = dbReader.GetOrdinal("КодСклада4");
                    int colКодРесурса1 = dbReader.GetOrdinal("КодРесурса1");
                    int colКодРесурса2 = dbReader.GetOrdinal("КодРесурса2");
                    int colКодСотрудника1 = dbReader.GetOrdinal("КодСотрудника1");
                    int colКодСотрудника2 = dbReader.GetOrdinal("КодСотрудника2");
                    int colКодСотрудника3 = dbReader.GetOrdinal("КодСотрудника3");
                    int colКодРасположения1 = dbReader.GetOrdinal("КодРасположения1");
                    int colКодБазисаПоставки = dbReader.GetOrdinal("КодБазисаПоставки");
                    int colКодВидаТранспорта = dbReader.GetOrdinal("КодВидаТранспорта");
                    int colКодМестаХранения = dbReader.GetOrdinal("КодМестаХранения");
                    int colКодЕдиницыИзмерения = dbReader.GetOrdinal("КодЕдиницыИзмерения");
                    int colКодСтавкиНДС = dbReader.GetOrdinal("КодСтавкиНДС");
                    int colКодТУзла1 = dbReader.GetOrdinal("КодТУзла1");
                    int colКодТУзла2 = dbReader.GetOrdinal("КодТУзла2");
                    int colКодТерритории = dbReader.GetOrdinal("КодТерритории");
                    int colКодСтатьиБюджета = dbReader.GetOrdinal("КодСтатьиБюджета");
                    int colДата2 = dbReader.GetOrdinal("Дата2");
                    int colДата3 = dbReader.GetOrdinal("Дата3");
                    int colДата4 = dbReader.GetOrdinal("Дата4");
                    int colДата5 = dbReader.GetOrdinal("Дата5");
                    int colFlag1 = dbReader.GetOrdinal("Flag1");
                    int colFlag2 = dbReader.GetOrdinal("Flag2");
                    int colInt1 = dbReader.GetOrdinal("Int1");
                    int colInt2 = dbReader.GetOrdinal("Int2");
                    int colInt3 = dbReader.GetOrdinal("Int3");
                    int colInt4 = dbReader.GetOrdinal("Int4");
                    int colInt5 = dbReader.GetOrdinal("Int5");
                    int colInt6 = dbReader.GetOrdinal("Int6");
                    int colInt7 = dbReader.GetOrdinal("Int7");
                    int colText50_1 = dbReader.GetOrdinal("Text50_1");
                    int colText50_2 = dbReader.GetOrdinal("Text50_2");
                    int colText50_3 = dbReader.GetOrdinal("Text50_3");
                    int colText50_4 = dbReader.GetOrdinal("Text50_4");
                    int colText50_5 = dbReader.GetOrdinal("Text50_5");
                    int colText50_6 = dbReader.GetOrdinal("Text50_6");
                    int colText50_7 = dbReader.GetOrdinal("Text50_7");
                    int colText50_8 = dbReader.GetOrdinal("Text50_8");
                    int colText50_9 = dbReader.GetOrdinal("Text50_9");
                    int colText50_10 = dbReader.GetOrdinal("Text50_10");
                    int colText50_11 = dbReader.GetOrdinal("Text50_11");
                    int colText50_12 = dbReader.GetOrdinal("Text50_12");
                    int colText50_13 = dbReader.GetOrdinal("Text50_13");
                    int colText100_1 = dbReader.GetOrdinal("Text100_1");
                    int colText100_2 = dbReader.GetOrdinal("Text100_2");
                    int colText100_3 = dbReader.GetOrdinal("Text100_3");
                    int colText100_4 = dbReader.GetOrdinal("Text100_4");
                    int colText100_5 = dbReader.GetOrdinal("Text100_5");
                    int colText100_6 = dbReader.GetOrdinal("Text100_6");
                    int colText300_1 = dbReader.GetOrdinal("Text300_1");
                    int colText300_2 = dbReader.GetOrdinal("Text300_2");
                    int colText300_3 = dbReader.GetOrdinal("Text300_3");
                    int colText300_4 = dbReader.GetOrdinal("Text300_4");
                    int colText300_5 = dbReader.GetOrdinal("Text300_5");
                    int colText300_6 = dbReader.GetOrdinal("Text300_6");
                    int colText300_7 = dbReader.GetOrdinal("Text300_7");
                    int colText300_8 = dbReader.GetOrdinal("Text300_8");
                    int colText300_9 = dbReader.GetOrdinal("Text300_9");
                    int colText1000_1 = dbReader.GetOrdinal("Text1000_1");
                    int colText1000_2 = dbReader.GetOrdinal("Text1000_2");
                    int colMoney1 = dbReader.GetOrdinal("Money1");
                    int colMoney2 = dbReader.GetOrdinal("Money2");
                    int colMoney3 = dbReader.GetOrdinal("Money3");
                    int colMoney4 = dbReader.GetOrdinal("Money4");
                    int colMoney5 = dbReader.GetOrdinal("Money5");
                    int colMoney6 = dbReader.GetOrdinal("Money6");
                    int colMoney7 = dbReader.GetOrdinal("Money7");
                    int colMoney8 = dbReader.GetOrdinal("Money8");
                    int colMoney9 = dbReader.GetOrdinal("Money9");
                    int colDecimal1 = dbReader.GetOrdinal("Decimal1");
                    int colDecimal2 = dbReader.GetOrdinal("Decimal2");
                    int colFloat1 = dbReader.GetOrdinal("Float1");
                    int colТекстДокумента = dbReader.GetOrdinal("ТекстДокумента");
                    #endregion
                    ...
                    if(dbReader.Read())
                    {
                        ...
                        if (!dbReader.IsDBNull(colКодРасположения1)) { LocationId1 = dbReader.GetInt32(colКодРасположения1); }
                        if (!dbReader.IsDBNull(colКодБазисаПоставки)) { BaseDeliveryId = dbReader.GetInt32(colКодБазисаПоставки); }
                        if (!dbReader.IsDBNull(colКодВидаТранспорта)) { TransportTypeId = dbReader.GetInt32(colКодВидаТранспорта); }
                        if (!dbReader.IsDBNull(colКодМестаХранения)) { StorageLocationId = dbReader.GetInt32(colКодМестаХранения); }
                        if (!dbReader.IsDBNull(colКодЕдиницыИзмерения)) { UnitsId = dbReader.GetInt32(colКодЕдиницыИзмерения); }
