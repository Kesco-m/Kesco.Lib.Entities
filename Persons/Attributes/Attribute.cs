...
namespace Kesco.Lib.Entities.Persons.Attributes
{
    ...
    public class Attribute : Entity
    {
        ...
        public object Create(byte check)
        {
            ...
            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ТипАтрибутаЛат"};
            result.Columns.Add(column);
            ...
            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ИмяАтрибутаЛат1"};
            result.Columns.Add(column);

            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ИмяАтрибутаЛат2"};
            result.Columns.Add(column);

            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ИмяАтрибутаЛат3"};
            result.Columns.Add(column);
            ...
            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ИмяАтрибутаРус1"};
            result.Columns.Add(column);

            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ИмяАтрибутаРус2"};
            result.Columns.Add(column);

            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ИмяАтрибутаРус3"};
            result.Columns.Add(column);

            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ЗначениеАтрибута1"};
            result.Columns.Add(column);

            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ЗначениеАтрибута2"};
            result.Columns.Add(column);

            column = new DataColumn {DataType = Type.GetType("System.String"), ColumnName = "ЗначениеАтрибута3"};
            result.Columns.Add(column);
        ...
        public DataTable Edit(byte check)
        {
            ...
            sqlParams.Add("@КодТипаАтрибута",
                new object[] {AttributeFormat.AttributeFormatBase.FormatTypeID, DBManager.ParameterTypes.Int32});
            sqlParams.Add("@От",
                DateStart == null
